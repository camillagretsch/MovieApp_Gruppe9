...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "movieapp_gruppe9" because\n';
  ...
  $wnd.__gwt_activeModules['movieapp_gruppe9'] = {
    'moduleName' : 'movieapp_gruppe9',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/movieapp_gruppe9.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['movieapp_gruppe9'].superdevmode = true;

  var expectedSuffix = '/movieapp_gruppe9.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + movieapp_gruppe9 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:movieapp_gruppe9';
  var devModeSessionKey = '__gwtDevModeSession:movieapp_gruppe9';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':53127';
  var nocacheUrl = serverUrl + '/movieapp_gruppe9/movieapp_gruppe9.nocache.js';
  ...
  $wnd.__gwt_activeModules['movieapp_gruppe9'].canRedirect = true;
  $wnd.__gwt_activeModules['movieapp_gruppe9'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING movieapp_gruppe9';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/movieapp_gruppe9?user.agent=' + ua + '&_callback=' + callback;
